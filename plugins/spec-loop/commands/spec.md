---
description: "Generate a spec.json for Spec Loop from a feature description"
...
If the user provided a feature description in the arguments, use it. Otherwise ask:
